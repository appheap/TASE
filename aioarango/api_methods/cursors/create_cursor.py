...
from typing import Optional, MutableMapping, Sequence, TYPE_CHECKING
...
class CreateCursor(Endpoint):
    ...
    async def create_cursor(
        ...
        -------
        Result
            A `Cursor` object is returned if the operation was successful.
        ...
        def response_handler(response: Response) -> "Cursor":
            ...
            return Cursor(self.connection, self.executor, response.body)
