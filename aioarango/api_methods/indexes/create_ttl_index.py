...
from aioarango.models.index import BaseArangoIndex, TTLIndex
...
class CreateTTLIndex:
    ...
    async def create_ttl_index(
        ...
        """
        Create a TTL index for the collection collection-name if it
        ...
        def response_handler(response: Response) -> TTLIndex:
