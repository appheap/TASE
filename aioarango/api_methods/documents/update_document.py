...
class UpdateDocument(Endpoint):
    error_codes = (
        ErrorType.ARANGO_DOCUMENT_KEY_BAD,
        ErrorType.ARANGO_COLLECTION_NOT_UNLOADED,
    ...
    status_codes = (
        ...
        409,  # 1210
        # is returned if the update causes a unique constraint violation in a secondary index.
