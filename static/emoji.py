...
_fallen_leaf = emoji.EMOJI_ALIAS_UNICODE[':fallen_leaf:']
_leaf_fluttering_in_wind = emoji.EMOJI_ALIAS_UNICODE[':leaf_fluttering_in_wind:']
...
# -------------Faces--------------------------
_smiling_face_with_heart = emoji.EMOJI_ALIAS_UNICODE[':smiling_face_with_heart-eyes:']
_face_blowing_a_kiss = emoji.EMOJI_ALIAS_UNICODE[':face_blowing_a_kiss:']
