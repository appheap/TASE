...
class Emoji(BaseModel):
    ...
    _italy_flag = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[":Italy:"]
    _spain_flag = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[":Spain:"]
    ...
    _germany_flag = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[":Germany:"]
    _netherlands_flag = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[":Netherlands:"]
    _portugal_flag = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[":Portugal:"]
    _zap = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[":zap:"]
    _globe_showing_Americas = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[
    ...
    _backhand_index_pointing_right = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[
        ":left_arrow_curving_right:"
    ]
    _exclamation_question_mark = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[
        ":exclamation_question_mark:"
    ]
    _mobile_phone_with_arrow = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[
    ...
    _leaf_fluttering_in_wind = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[
    ...
    # -------------Faces--------------------------
    _smiling_face_with_heart = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[
        ":smiling_face_with_heart-eyes:"
    ]
    _face_blowing_a_kiss = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[":face_blowing_a_kiss:"]
    _face_with_raised_eyebrow = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[
        ":face_with_raised_eyebrow:"
    ]
    _smiling_face_with_sunglasses = emoji.EMOJI_ALIAS_UNICODE_ENGLISH[
