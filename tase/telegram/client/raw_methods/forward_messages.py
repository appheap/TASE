...
async def forward_messages(
    ...
    Parameters:
        client : (``Client``)
            Pyrogram client to use for this function.
        chat_id (``int`` | ``str``):
        ...
        drop_author (``bool`` *optional*)
            Whether to remove the author of the message after forwarding or not.
        drop_media_captions (``bool`` *optional*)
            Whether to remove the media captions of the messages or not.
    ...
    for i in r.updates:
        if isinstance(i, (raw.types.UpdateNewMessage, raw.types.UpdateNewChannelMessage, raw.types.UpdateNewScheduledMessage)):
            forwarded_messages.append(await types.Message._parse(client, i.message, users, chats))
